...
export class ClassUtility {
    ...
    static toggleClassConditionally(element, condition, trueClass, falseClass) {
        if (condition) {
            ClassUtility.addClass(element, trueClass);
            ClassUtility.removeClass(element, falseClass);
        } else {
            ClassUtility.addClass(element, falseClass);
            ClassUtility.removeClass(element, trueClass);
        }
    }
    ...
    static replaceClassPrefix(element, oldPrefix, newPrefix) {
        ...
        classNames.forEach(className => {
            if (className.startsWith(oldPrefix)) {
                ClassUtility.removeClass(className);
                ClassUtility.addClass(element, className.replace(oldPrefix, newPrefix));
            }
        });
    }
    ...
    static addUniqueClass(element, className) {
        if (!ClassUtility.hasClass(element, className)) {
            ClassUtility.addClass(element, className)
        }
    }
    ...
    static toggleClassOnFocus(element, className) {
        ...
        this.element.addEventListener('blur', () => {
            ClassUtility.removeClass(element, className);
        });
    }
    ...
    static toggleClassOnDeviceMotion(element, className) {
        window.addEventListener('deviceorientation', (event) => {
            ...
            ClassUtility.toggleClass(element, className, isTilted);
        });
    }
    ...
    static toggleClassOnOrientationChange(element, className) {
        const handleOrientationChange = () => {
            ...
            ClassUtility.toggleClass(element, `${className}-${orientation}`);
        };
    ...
    static toggleClassOnSwipe(element,className) {
        ...
        element.addEventListener('touchend', (event) => {
            ...
            if (Math.abs(deltaX) > Math.abs(deltaY)) {
                // Horizontal Swipe
                ClassUtility.toggleClass(element, `${className}-horizontal`);
            } else {
                // Vertical Swipe
                ClassUtility.toggleClass(element, `${className}-vertical`);
            }
        });
    }
