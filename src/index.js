...
/**
 * Main module for the 'awedde' library, containing submodules for DOM, form, media, network, and device utilities.
 * @namespace
...
export default { dom, form, media, network, device, awedde };